...
"""
np.save('../data/5p_data/train_predictor_5p.npy', fn_train_5p)
#np.save('../data/5p_data/test_predictor_5p.npy', fn_test_5p)
np.save('../data/5p_data/train_target_5p.npy', dust_train_5p)
#np.save('../data/5p_data/test_target_5p.npy', dust_test_5p)