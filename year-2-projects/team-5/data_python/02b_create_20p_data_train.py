...
root2='/umbc/xfs1/cybertrn/cybertraining2019/team5/Research/CNN/data/testpredictor_norm/'
...
"""
np.save('../data/5p_data/train_predictor_20p.npy', fn_train_5p)
#np.save('../data/5p_data/test_predictor_20p.npy', fn_test_5p)
np.save('../data/5p_data/train_target_20p.npy', dust_train_5p)
#np.save('../data/5p_data/test_target_20p.npy', dust_test_5p)