...
np.save('../data/seasonal_data/spring_train_predictor.npy', np.array(season_train))
np.save('../data/seasonal_data/spring_test_predictor.npy', np.array(season_test))
np.save('../data/seasonal_data/spring_train_target.npy', np.array(season_train_dust))
np.save('../data/seasonal_data/spring_test_target.npy', np.array(season_test_dust))