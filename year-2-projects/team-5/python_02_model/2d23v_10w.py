...
#---------------------------------------------------------------------------------------------------------
# Load training data
train_predictor=np.load('../data/train_predictor.npy')[:,:,:,:23]
train_target=np.load('../data/train_target.npy')
# Load test data
test_predictor=np.load('../data/test_predictor.npy')[:,:,:,:23]
...
callbacks_list = [keras.callbacks.ModelCheckpoint(\
        filepath='../CNN_models/2d23v_10w/best_model.{epoch:02d}-{val_acc:.2f}.h5')]
