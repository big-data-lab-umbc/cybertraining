...
# Load training data
train_predictor=np.load('../data/5p_data/train_predictor_5p.npy')[:,:,:,:23]
train_target=np.load('../data/5p_data/train_target_5p.npy')
# Load test data
test_predictor=np.load('../data/5p_data/test_predictor_5p.npy')[:,:,:,:23]
...
callbacks_list = [keras.callbacks.ModelCheckpoint(\
        filepath='../CNN_models/5p_2d23v/best_model.{epoch:02d}-{val_loss:.2f}.h5')]
...
np.save('../CNN_history/5p_2d23v.npy', htry)