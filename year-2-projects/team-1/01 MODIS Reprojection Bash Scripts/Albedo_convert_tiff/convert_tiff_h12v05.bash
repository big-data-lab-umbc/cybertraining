...
# for converting HDF regional files (h12v05) to GeoTIFF files

DIR_NAME=$(cd "$(dirname "$0")";pwd)

echo $DIR_NAME

files=$(ls ${DIR_NAME}/heg.h12v05/)
...
BEGIN
INPUT_FILENAME = ${DIR_NAME}/heg.h12v05/${filename}
OBJECT_NAME = MOD_Grid_BRDF|
FIELD_NAME = Albedo_BSA_shortwave
BAND_NUMBER = 1
SPATIAL_SUBSET_UL_CORNER = ( 39.999999996 -78.324437349 )
...
OUTPUT_FILENAME = ${DIR_NAME}/tif_files/heg.h12v05/${outname}.tif
OUTPUT_TYPE = GEO
END
