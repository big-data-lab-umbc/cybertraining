...
This script creates, trains, and tests a Random Forest Classifier for the RUC 
sounding data for supercell storms that has been interpolated over 37 fixed 
heights.  

The Random Forest Classifier uses the 6x37 features:

'temperature 1-37', 'dewpoint 1-37', 'humidity 1-37', 'u-wind 1-37',
'v-wind 1-37', 'pressure 1-37'

to create decision trees and and classify each sample as one of the following:
...
RUCdata = interpolate_avg_height(RUCdata)
print('    -Number of height levels is 37 using height averages. \n',file = sum_file)
features = RUCdata.columns[0:6*37]
